...
AD5940Err AD5940_UTILITY_set_sequence_generator_buffer(
...
AD5940Err AD5940_UTILITY_clear_sequence_generator_buffer(void)
{
    AD5940_SEQGenInit(
        _sequence_generator_buffer, 
        _sequence_generator_buffer_length
...
AD5940Err AD5940_UTILITY_get_change_sequence_info_command(
    const uint8_t SEQID,
...
AD5940Err AD5940_UTILITY_change_sequence_info_command(
    const uint8_t SEQID,
    const uint16_t RegAddr, 
    const uint16_t RegLen
)
