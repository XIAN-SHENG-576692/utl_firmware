#include "ad5940_electrochemical_utility_sop.h"
...
AD5940Err AD5940_ELECTROCHEMICAL_UTILITY_write_sequence_commands_config(
...
)
{
     ...
     */
    AD5940_UTILITY_clear_sequence_generator_buffer();
