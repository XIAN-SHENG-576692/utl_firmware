...
typedef struct
{
    ...
    int (*put_quene)(AD5940_APPLICATION_ADC_RESULT adc_result);
    int (*take_quene)(AD5940_APPLICATION_ADC_RESULT *const adc_result);

    int (*wait_ad5940_intc_triggered)(void);
} AD5940_APPLICATION_ADC_PORT;

typedef struct
{
    AD5940_APPLICATION_ADC_PORT port;
} AD5940_APPLICATION_ADC_CFG;
...
typedef enum {
    AD5940_APPLICATION_ADC_STATE_UNINITIALIZED,
    AD5940_APPLICATION_ADC_STATE_IDLE,
    AD5940_APPLICATION_ADC_STATE_EXECUTING,
    AD5940_APPLICATION_ADC_STATE_ERROR,
} AD5940_APPLICATION_ADC_STATE;
