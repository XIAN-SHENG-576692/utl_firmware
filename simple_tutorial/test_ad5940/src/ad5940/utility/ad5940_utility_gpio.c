#include "ad5940_utility_gpio.h"

void AD5940_UTILITY_clear_GPIO_and_INT_flag(void)
{
...
void AD5940_UTILITY_get_AfeIntcSel_by_AGPIOCfg_Type(
...
void AD5940_UTILITY_set_INTCCfg_by_AGPIOCfg_Type(
    const AGPIOCfg_Type *const agpio_cfg,
...
)
{
    ...
    AD5940_UTILITY_get_AfeIntcSel_by_AGPIOCfg_Type(agpio_cfg, &AFEINTC_0_enable, &AFEINTC_1_enable);
